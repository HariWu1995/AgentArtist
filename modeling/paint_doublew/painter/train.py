...
from models import critic, wgan, networks
...
class Coach():
    ...
    def __init__(self, args):
        ...
        if args.resume_iter != -1:
            self.net_g.load_state_dict(
                  torch.load(os.path.join(args.save_dir,      'E-%s-%d.pth' % (args.dataset, args.resume_iter))))
    ...
    def train(self):
        ...
        while self.global_step < 2_000_000:
            self.losses = dict()
    ...
    def configure_datasets(self):
        ...
        self.train_dataloader = DataLoader(self.train_data, batch_size=self.opts.batch_size,
                                           shuffle=True, num_workers=8, drop_last=True)
        self.test_dataloader = DataLoader(self.test_data, batch_size=self.opts.batch_size,
                                          shuffle=True, num_workers=8, drop_last=True)
